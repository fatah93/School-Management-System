...
<body>
   ...
   @php
   $discount = rand(5,10);
   $Registration_fee = App\Models\FeeAmount::where('fee_category_id', '4')->where('class_id', $details->class_id)->first();
   ...
   <table>
      ...
      <tr class="info1">
         ...
         <td style="text-align: center;" class="info2">Total Fee for <strong>{{$exam_type}}</strong>: </td>
