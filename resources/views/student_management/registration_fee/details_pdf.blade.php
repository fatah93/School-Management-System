...
<body>
   <htmlpageheader name="page-header">
      <div class="center">
         <h2>Informations Regstration Fee</h2>
      </div>
   </htmlpageheader>
   ...
   @php
   $discount = rand(5,10);
   $Registration_fee = App\Models\FeeAmount::where('fee_category_id', '1')->where('class_id', $details->class_id)->first();
   ...
   <table>
      ...
      <tr class="info1">
         <td style="text-align: left;">Fee Student </td>
      ...
      <tr class="info1">
         ...
         <td style="text-align: right;" class="info2"> {{$finalfee}} $</td>
      </tr>
   </table>

   <htmlpagefooter name="page-footer">
      <hr>
      <i>Print Date : {{date("Y-h-m")}}</i>
   </htmlpagefooter>
</body>
