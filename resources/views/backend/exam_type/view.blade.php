   ...
   <div class="row page-titles mx-0">
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Exam Type List</a></li>
         </ol>
      </div>
   </div>
   <!-- row -->
            ...
            <div class="card">
               <div class="card-body">
                  <div class="card-title">
                     <button class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#AddExamType" style="float: right;">Add new</button>
                  </div>
                  @if(count($allData)>=1)
                              ...
                              <table class="table table-hover" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                       <td width='5%'>{{$key+1}} </td>
                                       <td width='20%'>{{ $exam->name}}</td>
                                       <td width='20%'>{{ $exam->created_at->diffForHumans()}} </td>
                                       <td width='15%'>
                                          <a href="#" data-toggle="modal" data-target="#ModalUpdatExamType{{$exam->id}}">
                                          ...
                                          <form action="{{ route('exam.type.update',$exam->id)}}" method="post" autocomplete="off">
                                             @csrf
                                             <div class="modal fade" id="ModalUpdatExamType{{$exam->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                   ...
                                                   <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-7">
                                                               <input type="text" class="form-control input-rounded" id="name" name="name" value="{{ $exam->name}}">
                                                               @error('name')
...
<!--Add new class Store-->
<form action="{{ route('exam.type.store')}}" method="post" autocomplete="off">
   @csrf
   <div class="modal fade bd-example-modal-lg" id="AddExamType" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title">Add new exam type</h5>
               <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <div class="form-group row">
                  ...
                  <div class="col-lg-7">
                     <input type="text" class="form-control input-rounded" id="name" name="name" placeholder="Enter Exam type name">
                     @error('name')
                     <div class="text-danger">{{ $message }}</div>
                     @enderror
                  </div>
            ...
            <div class="modal-footer">
               <input type="submit" value="Add exam" class="btn btn-primary btn-rounded">
            </div>
         </div>
      </div>
   </div>
