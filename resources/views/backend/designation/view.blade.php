            ...
            <div class="card">
               <div class="card-body">
                  <div class="card-title">
                     ...
                     <button class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#AddDesignation" style="float: right;">Add designation</button>
                     <!-- Moda Add New School Subject-->
                     <form action="{{ route('designation.store')}}" method="post" autocomplete="off">
                        @csrf
                        <div class="modal fade bd-example-modal-lg" id="AddDesignation" tabindex="-1" role="dialog" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-7">
                                          <input type="text" class="form-control input-rounded" id="name" name="name" placeholder="Enter Designation">
                                          @error('name')
                                 ...
                                 <div class="modal-footer">
                                    <input type="submit" value="Save Designation" class="btn btn-primary btn-rounded">
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <table class="table table-hover" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                       ...
                                       <td width='20%'>{{ $designation->created_at->diffForHumans()}} </td>
                                       <td width='15%'>
                                          <a href="#" data-toggle="modal" data-target="#ModalUpdatedesignation{{$designation->id}}">
                                          ...
                                          <form action="{{ route('designation.update',$designation->id)}}" method="post" autocomplete="off">
                                             @csrf
                                             <div class="modal fade" id="ModalUpdatedesignation{{$designation->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                   <div class="modal-content">
                                                      <div class="modal-header">
                                                      ...
                                                      <div class="modal-body">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-7">
                                                               <input type="text" class="form-control input-rounded" id="name" name="name" value="{{ $designation->name}}">
                                                               @error('name')
                                                               <div class="text-danger">{{ $message }}</div>
                                                               @enderror
                                                            </div>
                  ...
                  @else
                  <p>No data selected for designation Subject add new one</p>
                  @endif
               </div>
            </div>
         </div>
