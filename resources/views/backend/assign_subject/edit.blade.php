   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <form action="{{ route('assign.subject.update',$editData[0]->class_id)}}" method="post" autocomplete="off">
                     @csrf
                     <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                           <select class="form-control input-rounded" id="val-skill" name="class_id" required>
                              ...
                              <option value="{{ $class->id}}" {{ ($class->id == $editData['0']->class_id) ? "selected" : "" }}>
                                 <font style="vertical-align: inherit;">
                           ...
                           <div class="form-group row">
                              <div class="col-lg-4">
                                 <select class="form-control input-rounded" id="val-skill" name="subject_id[]" required>
                                    ...
                                    <option value="{{ $subject->id}}" {{($subject->id == $edit->subject_id) ? "selected" : ""}}>
                                       <font style="vertical-align: inherit;">
                              ...
                              <div class="col-lg-2">
                                 <input type="text" class="form-control input-rounded" id="name" name="full_mark[]" value="{{ $edit->full_mark}}">
                              </div>
                              <div class="col-lg-2">
                                 <input type="text" class="form-control input-rounded" id="name" name="pass_mark[]" value="{{$edit->pass_mark}}">
                              </div>
                              <div class="col-lg-2">
                                 <input type="text" class="form-control input-rounded" id="name" name="subjective_mark[]" value="{{ $edit->subjective_mark}}">
                              </div>
