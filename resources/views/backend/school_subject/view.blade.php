   ...
   <div class="row page-titles mx-0">
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">School Subject List</a></li>
         </ol>
      </div>
   </div>
   <!-- row -->
            ...
            <div class="card">
               <div class="card-body">
                  <div class="card-title">
                     ...
                     <button class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#AddSchoolSubject" style="float: right;">Add new</button>
                     <!-- Moda Add New School Subject-->
                     <form action="{{ route('school.subject.store')}}" method="post" autocomplete="off">
                        @csrf
                        <div class="modal fade bd-example-modal-lg" id="AddSchoolSubject" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                              <div class="modal-content">
                                 <div class="modal-header">
                                    <h5 class="modal-title">Add new School Dubject</h5>
                                 ...
                                 <div class="modal-body">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-7">
                                          <input type="text" class="form-control input-rounded" id="name" name="name" placeholder="Enter School subject">
                                          @error('name')
                                 ...
                                 <div class="modal-footer">
                                    <input type="submit" value="Save School Subject" class="btn btn-primary btn-rounded">
                                 </div>
                              </div>
                           </div>
                        </div>
                     </form><!--End Modal Add new Subject-->
                  </div>
                  @if(count($allData)>=1)
                              ...
                              <table class="table table-hover" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                       ...
                                       <td width='20%'>{{ $school->created_at->diffForHumans()}} </td>
                                       <td width='15%'>
                                          <a href="#" data-toggle="modal" data-target="#ModalUpdateSchoolSubject{{$school->id}}">
                                             <i class="fa fa-pencil color-muted m-r-5"></i>
                                          </a> &nbsp;
                                          <a href="{{ route('school.subject.delete',$school->id)}}" id="delete">
                                             <i class="fa fa-trash color-muted m-r-5"></i>
                                          </a>
                                          <!--Form Exam Type update-->
                                          <form action="{{ route('school.subject.update',$school->id)}}" method="post" autocomplete="off">
                                             @csrf
                                             <div class="modal fade" id="ModalUpdateSchoolSubject{{$school->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                   <div class="modal-content">
                                                      <div class="modal-header">
                                                         <h5 class="modal-title">Update School Subject</h5>
                                                         <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                         </button>
                                                      </div>
                                                      <div class="modal-body">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-7">
                                                               <input type="text" class="form-control input-rounded" id="name" name="name" value="{{ $school->name}}">
                                                               @error('name')
                                                               <div class="text-danger">{{ $message }}</div>
                                                               @enderror
                                                            </div>
                  ...
                  @else
                  <p>No data selected for School Subject add new one</p>
                  @endif
               </div>
            </div>
         </div>
