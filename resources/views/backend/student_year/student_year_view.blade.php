   ...
   <div class="row page-titles mx-0">
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">View Year</a></li>
         </ol>
      </div>
   </div>
   <!-- row -->
            ...
            <div class="card">
               <div class="card-body">
                  <div class="card-title">
                     <button class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#AddStudentYear" style="float: right;">Add new</button>
                  </div>
                  @if(count($allData)>=1)
                              ...
                              <table class="table table-hover" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                       <td width='5%'>{{$key+1}} </td>
                                       <td width='20%'>{{ $year->name}}</td>
                                       <td width='20%'>{{ $year->created_at->diffForHumans()}} </td>
                                       <td width='15%'>
                                          <a href="#" data-toggle="modal" data-target="#ModalUpdateYear{{$year->id}}">
                                          ...
                                          <form action="{{ route('student.year.update',$year->id)}}" method="post" autocomplete="off">
                                             @csrf
                                             <div class="modal fade" id="ModalUpdateYear{{$year->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                   <div class="modal-content">
                                                      <div class="modal-header">
                                                         <h5 class="modal-title">Update Student Year</h5>
                                                      ...
                                                      <div class="modal-body">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-7">
                                                               <input type="text" class="form-control input-rounded" id="name" name="name" value="{{ $year->name}}">
                                                               @error('name')
...
<!--Student class Store-->
<form action="{{ route('student.year.store')}}" method="post" autocomplete="off">
   @csrf
   <div class="modal fade bd-example-modal-lg" id="AddStudentYear" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
               <div class="form-group row">
                  ...
                  <div class="col-lg-7">
                     <input type="text" class="form-control input-rounded" id="name" name="name" placeholder="Enter sudent Year">
                     @error('name')
                     <div class="text-danger">{{ $message }}</div>
                     @enderror
                  </div>
