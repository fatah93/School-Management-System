            ...
            <div class="card">
               <div class="card-body">
                  <div class="card-title">
                     <button class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#AddStudentClass" style="float: right;">Add new</button>
                  </div>
                  @if(count($allData)>=1)
                              ...
                              <table class="table table-hover" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                       ...
                                       <td width='20%'>{{ $class->created_at->diffForHumans()}} </td>
                                       <td width='15%'>
                                          <a href="#" data-toggle="modal" data-target="#ModalUpdateUser{{$class->id}}">
                                             <i class="fa fa-pencil color-muted m-r-5"></i>
                                          </a> &nbsp;
                                          <a href="{{ route('student.class.delete',$class->id)}}" id="delete">
                                             <i class="fa fa-trash color-muted m-r-5"></i>
                                          </a>
                                          <!--Student class update-->
                                          <form action="{{ route('student.class.update',$class->id)}}" method="post" autocomplete="off">
                                             @csrf
                                             <div class="modal fade" id="ModalUpdateUser{{$class->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                   ...
                                                   <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-7">
                                                               <input type="text" class="form-control input-rounded" id="name" name="name" value="{{ $class->name}}">
                                                               @error('name')
...
<form action="{{ route('student.class.store')}}" method="post" autocomplete="off">
   @csrf
   <div class="modal fade bd-example-modal-lg" id="AddStudentClass" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
               <div class="form-group row">
                  ...
                  <div class="col-lg-7">
                     <input type="text" class="form-control input-rounded" id="name" name="name" placeholder="Enter sudent class name">
                     @error('name')
                     <div class="text-danger">{{ $message }}</div>
                     @enderror
                  </div>
